...
source_url: "https://namu.wiki/w/%ED%95%A0%EB%A1%9C%EC%9A%B0%20%EC%9E%B0"
entity_refs: ["할로우-잰"]
...
싱글 <An Inaudible Voice> 2024년 11월 발매 [7]
...
5.1. 참여곡[8]
[편집]
로만티카 - Only One Slight Eternity
바세린 - Flowers In The Sand, From Nothing To Infinity
신가람 - Runaway
신스네이크 - Ire Of Lilithfeat
정크필름 - 이대로 난 흘러가는가
태지윤 - 개루저
키라라 - 증발
6. 영상
[편집]
정규 1집 수록곡 "Empty" 온스테이지



정규 1집 수록곡 "Blaze The Trail" EBS 스페이스 공감
...
[1] 데모 EP 발매년도는 2004년이며 결성은 2003년에 했기 때문에 순수한 '데뷔' 연도를 놓고 보면 2003년이 맞다. 데모는 2003년 10월 결성 후 4개월 정도 후에 작업을 시작했고, 그 전까지는 '임환택 밴드', 또는 '이광재 밴드' (...)라는 이름으로 합주실 예약을 했었다고.
[2] 現 노브레인. a.k.a. 뽀글. 2022년부터 할로우 잰의 신곡 (EP 다떠위다) 작업을 위해 세션 멤버로 합류하여 현재는 정규 멤버가 되었다.
[3] 現 서태지밴드, 루디스텔로. 서태지밴드의 그 최현진이다. 2024년부로 이전 드러머였던 류명훈의 뒤를 이어 할로우 잰에 합류하게 되었다.
[4] 망원동에서 소규모 지하 공연장인 클럽 샤프(Club Sharp)와 타투샵 샤프 잉크 (Sharp Ink)를 운영하고 있다.
[5] a.k.a. 정크 클래스 (Junk Class).
[6] 전 멤버 증재가 2016년 10월 공연을 마지막으로 개인 사정으로 인해 탈퇴
[7] 해당 싱글 앨범 발매 직후 발매 기념 단독 공연을 열었다.
[8] 보컬 임환택의 개인 참여곡
